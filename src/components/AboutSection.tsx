      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16" data-aos="fade-up">
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
            <span className="text-foreground">About</span> <span className="text-shimmer">Avensora</span>
          </h2>
          ...
          <div data-aos="fade-right" data-aos-delay="200">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center">
                ...
                <span className="text-foreground font-medium">50+ Team Members</span>
              </div>
            </div>
          </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <Card key={index} className="text-center hover-glow cursor-pointer bg-card border-border" data-aos="fade-up" data-aos-delay={200 + index * 100}>
                ...
                <CardContent className="p-6 card-content-wrapper">
                  <div className="card-content-body">
                    <div className="relative mb-4">
                      ...
                      />
                      <div className="absolute inset-0 rounded-full bg-gradient-to-br from-primary/20 to-secondary/20 opacity-0 hover:opacity-100 transition-opacity duration-300"></div>
                    </div>
